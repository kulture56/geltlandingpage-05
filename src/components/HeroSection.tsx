...
const HeroSection = () => {
  ...
  return <Hero className="pt-20 pb-12 md:pt-24 md:pb-16 lg:pt-28 lg:pb-20">
      ...
      <div className="container mx-auto px-4 flex items-center justify-center h-full">
        <div className="text-center max-w-3xl z-10">
          <AnimatedContainer>
            ...
            <TextStagger as="p" text="Karibu! Join Kenya's premier social-fintech platform connecting investors with knowledge, community, and opportunities." className="text-lg md:text-xl mb-6 text-gray-700 mx-auto" stagger={0.02} direction="bottom" />
          </AnimatedContainer>
