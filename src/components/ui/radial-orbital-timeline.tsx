...
export default function RadialOrbitalTimeline({
  ...
  return <div className="w-full h-[600px] flex flex-col items-center justify-center bg-black overflow-hidden" ref={containerRef} onClick={handleContainerClick}>
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        transform: `translate(${centerOffset.x}px, ${centerOffset.y}px)`
          ...
          return <div key={item.id} ref={el => nodeRefs.current[item.id] = el} className="absolute transition-all duration-700 cursor-pointer" style={nodeStyle} onClick={e => {
            e.stopPropagation();
            toggleItem(item.id);
          }}>
