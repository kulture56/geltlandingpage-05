...
const GradientCardSection = () => {
  ...
  return (
    <Hero className="pt-12 pb-12 md:pt-16 md:pb-16 lg:pt-20 lg:pb-20">
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-8 lg:gap-16">
