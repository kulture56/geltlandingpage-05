    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-center">Frequently Asked Questions</h1>
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="item-1" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">What is GELT?</span>
              </AccordionTrigger>
            ...
            <AccordionItem value="item-2" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">Who can use GELT?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-600">
            ...
            <AccordionItem value="item-3" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">Is GELT a licensed financial institution?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-600">
            ...
            <AccordionItem value="item-4" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">How does GELT protect my data?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-600">
            ...
            <AccordionItem value="item-5" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">What is Rafiki AI?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-600">
            ...
            <AccordionItem value="item-6" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">Are there any fees associated with using GELT?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-600">
            ...
            <AccordionItem value="item-7" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">How can I delete my account?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-600">
            ...
            <AccordionItem value="item-8" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">How do I access the platform?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-600">
            ...
            <AccordionItem value="item-9" className="bg-white rounded-lg shadow-sm border border-gray-100">
              <AccordionTrigger className="px-6 py-4 hover:no-underline">
                <span className="text-lg font-medium text-left">How do I report harmful or abusive content?</span>
              </AccordionTrigger>
              <AccordionContent className="px-6 pb-4 text-gray-600">
